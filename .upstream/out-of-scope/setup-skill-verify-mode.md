...
A second skill (or a `--verify` flag) for checking whether `documentation/agents/*.md` artifacts still match the seed-template schema would duplicate work the existing setup skill already handles in conversation.

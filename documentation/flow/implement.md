...
If the tickets came from [to-tickets](https://aihero.dev/skills-to-tickets), the tracker they live on was configured by [setup-custom-skills](https://aihero.dev/skills-setup-custom-skills). `code-review` reads the same configuration to find the originating spec at close-out.
...
[what-is-next](https://aihero.dev/skills-what-is-next) is the router over the whole set when you are not sure which flow you are in.

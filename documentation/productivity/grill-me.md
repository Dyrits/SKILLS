...
"One long form or three pages?" and "how should this interaction feel?" are **ungrillable**: they need something to react to. When you hit one, stop grilling. Build the throwaway version with [prototype](../shaping/prototype.md), look at it, then come back and answer in one line.
...
**Do I start a fresh session before writing the specification?**
No. The value of the session is the context you just built. Hand the same conversation straight to [to-specifications](../workflow/to-specifications.md).

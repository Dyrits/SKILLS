---
name: what-is-next
description: Figure out the next move: which skill or flow fits your situation, or which boundary option (continue, clear, handoff, compact) fits the moment. A router over the skills and flows in this repo.
...
**`/setup-custom-skills`**: run before your first flow to configure the issue tracker, triage labels, and doc layout the other skills assume. Custom issue trackers also work.

...
- Add `.agents/handoffs/` to `.gitignore` if the user wants local-only history, or commit them if the team wants shared history. Ask once; remember via the repo's config or AGENTS.md note

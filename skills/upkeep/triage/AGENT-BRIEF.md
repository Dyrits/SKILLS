...
- **Good:** "Running `gh issue list --label to-evaluate` returns issues that have been through initial classification"
...
- Bug reports (only enhancement rejections go to `documentation/out-of-scope/`)
```

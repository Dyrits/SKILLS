...
The goal is a PR which implements the entire specification on a single branch.
...
1. Read the specification and tickets. Read enough to understand the task graph.
...
3. Create a branch, and a draft PR. The PR should be marked as 'closing' the specification issue and tickets.

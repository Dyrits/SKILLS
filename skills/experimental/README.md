...
- **[publish-message](./publish-message/SKILL.md)**: Clean a short comment, then publish it to a GitHub/GitLab pull/merge request or Jira issue after the user approves the final text and destination.
- **[publish-review](./publish-review/SKILL.md)**: Clean a finished `/code-review` report, then publish its summary and inline suggestions after the user approves the complete set and destination.
